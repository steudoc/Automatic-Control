...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . fmjqtlolcf ) , 0 , 0 , 15 } ,
{ ( char_T * ) ( & rtDW . azq3dz05k2 . LoggedData ) , 11 , 0 , 3 } } ; static
DataTypeTransitionTable rtBTransTable = { 2U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP . Gb ) , 0 ,
0 , 13 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
